...
public class JwtTokenUtil implements Serializable {
	...
	// Este metodo obtem o email que esta dentro do Token
	...
	// Retorna a data em que o token jwt irá expirar
	...
	// Reliza a extração das informações imbutidas no corpo do JWT
